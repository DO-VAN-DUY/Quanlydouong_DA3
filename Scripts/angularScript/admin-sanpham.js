app.controller("AdminSanPhamCtrl", function ($scope, $http, $window) {
    ...
    $scope.LoadDanhSach = function (page, limit) {
        $http({
            method: 'GET',
            url: 'https://localhost:44342/Admin/GetDanhSach/?page=' + page + '&limit=' + limit,
        ...
        if (action === "Thêm mới") {
            ...
            if (file) {
                ...
                $http({
                    ...
                    $http({
                        method: 'POST',
                        url: 'https://localhost:44342/Admin/AjaxAddSanPham',
                        datatype: 'json',
            ...
            if (file) {
                ...
                $http({
                    ...
                    $http({
                        method: 'POST',
                        url: 'https://localhost:44342/Admin/AjaxUpdateSanPham',
                        datatype: 'json',
                        data: JSON.stringify(sp)
                    }).then(function (response) {
                        if (response.data == 1) {
    ...
    $scope.Xoa = function (item) {
        $http({
            method: 'POST',
            url: 'https://localhost:44342/Admin/AjaxXoaSanPham',
            datatype: 'json',
